...
public class UserManagementController {
    ...
    private void setupTableColumns() {
        ...
        // Compter les tâches de chaque utilisateur
        ...
        actionsColumn.setCellFactory(param -> new TableCell<>() {
            ...
            protected void updateItem(Void item, boolean empty) {
                ...
                if (empty) {
                    ...
                    // Désactiver le bouton supprimer pour l'utilisateur actuel
    ...
    private void updateStatistics() {
        try {
            ...
            // Pour "actifs aujourd'hui", vous pouvez implémenter une logique de dernière connexion
    ...
    private void handleFilterChange(ActionEvent event) {
        ...
        usersTable.setItems(filtered);
        updateCount();
        statusLabel.setText("Filtre appliqué: " + filter);
    }
    ...
    private void handleChangeRole(ActionEvent event) {
        ...
        // Convertir le rôle actuel en String pour le dialogue
        ...
        result.ifPresent(newRoleStr -> {
            if (!newRoleStr.equals(currentRoleStr)) {
                try {
                    ...
                    showAlert("Erreur", "Rôle invalide: " + newRoleStr);
                } catch (Exception e) {
    ...
    private void handleResetPassword(ActionEvent event) {
        ...
        result.ifPresent(newPassword -> {
            ...
            try {
                ...
                boolean success = userDAO.updateUser(selected);
                if (success) {
                    showAlert("Succès", "Mot de passe réinitialisé pour " + selected.getUsername());
                    statusLabel.setText("Mot de passe réinitialisé");
                } else {
                    showAlert("Erreur", "Impossible de réinitialiser le mot de passe");
                }
    ...
    private void handleDeleteUserDirect(User user) {
        ...
        try {
            ...
            confirm.setContentText(
                    "Cet utilisateur a " + taskCount + " tâche(s).\n" +
            ...
            if (result.isPresent() && result.get() == ButtonType.OK) {
                ...
                if (success) {
                    ...
                    updateStatistics();
                    updateCount();
                    statusLabel.setText("Utilisateur supprimé: " + user.getUsername());
                } else {
    ...
    private void handleViewUser(User user) {
        try {
            ...
            showAlert("Erreur", "Erreur lors de la récupération des détails: " + e.getMessage());
        }
    }

    private void handleEditUser(User user) {
        // Pour simplifier, on utilise le changement de rôle
